...
aws dynamodb create-table \
    ...
    --provisioned-throughput \
        ReadCapacityUnits=1,WriteCapacityUnits=4 \
    --endpoint-url http://localhost:8000
-build
  sam build
- invoke

sam local invoke newsletterSignupFunction --event event.json --docker-network dynamodb-network
- check
